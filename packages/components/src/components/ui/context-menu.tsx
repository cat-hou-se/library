...
function ContextMenuShortcut({ className, ...props }: ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground ml-auto text-xs tracking-widest group-focus/context-menu-item:text-accent-foreground",
        className,
      )}
      {...props}
    />
