...
function Carousel({
  ...
  // api 생성 시 초기 스크롤 상태 동기화 (렌더 중 상태 조정 패턴)
  const currentCanScrollPrev = api?.canScrollPrev() ?? false
  const currentCanScrollNext = api?.canScrollNext() ?? false
  if (currentCanScrollPrev !== canScrollPrev) setCanScrollPrev(currentCanScrollPrev)
  if (currentCanScrollNext !== canScrollNext) setCanScrollNext(currentCanScrollNext)
